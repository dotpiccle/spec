...
The normative timing rules remain in `docs/05-layer-volume.md`, `docs/07-spatial-effects.md`, `docs/08-output.md`, and `docs/11-engine-safety.md`. Engines should reproduce these cases in their own scheduler tests.
